...
module params
  ...
  type CritEngine
    ...
    double precision :: nr_mixing = 0.3 ! Newton-Raphson mixing parameter
    ...
    double precision :: atom_density_abandon = 0.4 ! give up search if "atom density" is below this number
    double precision :: rtrust = 0.27 ! give up search if another critical point is closer than this distance
